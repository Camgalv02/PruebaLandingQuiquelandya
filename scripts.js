...
const translations = {
    es: {
        ...
        messagePlaceholder: "Escriba aquí su mensaje \n(Por ejemplo: ¡Hola! Quiero reservar [cabañas, salones, camping, motorhomes].)",
        ...
        cabinSection: {
            ...
            bathrooms: "Baños",
            bathroomsDesc: "Naturaleza en estado puro"
        },
        poolSection: {
        ...
        motorhomeSection: {
            premium: "Espacio Premium",
            premiumDesc: "Máximo confort para tu motorhome",
            relax: "Zona de Relajo",
            relaxDesc: "Tranquilidad y comodidad en plena naturaleza",
            grill: "Área de parrillas",
            grillDesc: "Parrilladas inolvidables en plena naturaleza",
            rest: "Área de Descanso",
            restDesc: "Espacios amplios y seguros para tu motorhome"
        },
        hallSection: {
            main: "Salón Principal",
            mainDesc: "Elegancia y versatilidad para tus celebraciones",
            meetings: "Salón de Reuniones",
            meetingsDesc: "Espacio ideal para encuentros y conferencias",
            banquet: "Salón de Banquetes",
            banquetDesc: "Perfecto para cenas y eventos especiales",
            party: "Salón de Fiestas",
            partyDesc: "Diversión asegurada para cualquier ocasión"
        },
    },
    en: {
        // Navigation
        ...
        messagePlaceholder: "Type your message here \n(For example: Hi! I want to book [cabins, event halls, camping spots, motorhome areas].)",
        ...
        motorhomeSection: {
            ...
            premiumDesc: "Maximum comfort for your motorhome",
            relax: "Relaxation Zone",
            relaxDesc: "Peace and comfort in nature",
            grill: "Grill Area",
            grillDesc: "Unforgettable barbecues in nature",
            rest: "Rest Area",
            restDesc: "Spacious and safe areas for your motorhome"
        },
        hallSection: {
            main: "Main Hall",
            mainDesc: "Elegance and versatility for your celebrations",
            meetings: "Meeting Hall",
            meetingsDesc: "Ideal space for meetings and conferences",
            banquet: "Banquet Hall",
            banquetDesc: "Perfect for dinners and special events",
            party: "Party Hall",
            partyDesc: "Guaranteed fun for any occasion"
        },
    ...
    pt: {
        ...
        messagePlaceholder: "Escreva sua mensagem aqui \n(Por exemplo: Olá! Quero reservar [cabines, salões de eventos, áreas de camping, áreas de motorhomes].)",
        sendWhatsapp: "Enviar Whatsapp",
        ...
        cabinSection: {
            ...
            bathrooms: "Banheiros",
            bathroomsDesc: "Natureza em estado puro"
        },
        poolSection: {
        ...
        motorhomeSection: {
            premium: "Espaço Premium",
            premiumDesc: "Máximo conforto para seu motorhome",
            relax: "Zona de Relaxamento",
            relaxDesc: "Tranquilidade e conforto na natureza",
            grill: "Área de churrasqueira",
            grillDesc: "Churrascos inesquecíveis na natureza",
            rest: "Área de Descanso",
            restDesc: "Espaços amplos e seguros para seu motorhome"
        },
        hallSection: {
            main: "Salão Principal",
            mainDesc: "Elegância e versatilidade para suas celebrações",
            meetings: "Salão de Reuniões",
            meetingsDesc: "Espaço ideal para encontros e conferências",
            banquet: "Salão de Banquetes",
            banquetDesc: "Perfeito para jantares e eventos especiais",
            party: "Salão de Festas",
            partyDesc: "Diversão garantida para qualquer ocasião"
        }
...
function openGallery(type) {
    ...
    switch (type) {
        case 'cabanas':
            ...
            galleryImages = [
                { src: "./img/hike-7486771_1280.jpg", title: sectionData.exterior, description: sectionData.exteriorDesc },
                { src: "./img/hike-7486771_1280.jpg", title: sectionData.interior, description: sectionData.interiorDesc },
                { src: "./img/hike-7486771_1280.jpg", title: sectionData.bathrooms, description: sectionData.bathroomsDesc }
            ];
            break;
        case 'piletas':
        ...
        case 'aereo':
            ...
            galleryImages = [
                { src: "./img/tirolesas.jpg", title: sectionData.zipline, description: sectionData.ziplineDesc },
                { src: "./img/senderoParque.jpeg", title: sectionData.circuit, description: sectionData.circuitDesc },
                { src: "./img/vistaParqueAereo.jpeg", title: sectionData.panoramic, description: sectionData.panoramicDesc },
                { src: "./img/juegosParqueAereo.jpeg", title: sectionData.games, description: sectionData.gamesDesc }
            ];
            break;
        case 'camping':
            ...
            galleryImages = [
                ...
                { src: "./img/zonaParrilla.jpg", title: sectionData.grill, description: sectionData.grillDesc },
        ...
        case 'motorhomes':
            ...
            galleryImages = [
                { src: "./img/exampleMotorhome.jpg", title: sectionData.premium, description: sectionData.premiumDesc },
                { src: "./img/exampleMotorhome.jpg", title: sectionData.relax, description: sectionData.relaxDesc },
                { src: "./img/zonaParrilla.jpg", title: sectionData.grill, description: sectionData.grillDesc },
                { src: "./img/exampleMotorhome.jpg", title: sectionData.rest, description: sectionData.restDesc }
            ];
            break;
        case 'salones':
            sectionData = translation.hallSection;
            galleryImages = [
                { src: "./img/exampleSalones.jpg", title: sectionData.main, description: sectionData.mainDesc },
                { src: "./img/exampleSalones.jpg", title: sectionData.meetings, description: sectionData.meetingsDesc },
                { src: "./img/exampleSalones.jpg", title: sectionData.banquet, description: sectionData.banquetDesc },
                { src: "./img/exampleSalones.jpg", title: sectionData.party, description: sectionData.partyDesc }
            ];
            break;
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Añadir un estilo de medios para dispositivos móviles
  ...
  @media (max-width: 768px) {
    ...
    #galleryModal .gallery-close {
        ...
        top: 130px !important; /* Changed from -50px to positive value */
    ...
    #galleryModal .carousel-control-next {
        ...
        .logo {
    max-width: 140px; /* Ajusta este valor según necesites */
}
}
    `;
